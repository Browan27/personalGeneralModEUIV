...
NDiplomacy = {
	...
	PEACE_COST_CONCEDE_PROVINCE = 0.75,				-- Demand colonial area province concession.
	PEACE_COST_BECOME_VASSAL = 1,					-- Vassalize a country (scales by province wealth)
	PEACE_COST_RETURN_CORE = 0.75,						-- Return a core (scales by province wealth)
	PEACE_COST_REVOKE_CORE = 0.25,						-- Revoke a core (scales by province wealth)
	PEACE_COST_RELEASE_ANNEXED = 0.75,					-- Release annexed nation (scales by province wealth)
	...
	PEACE_COST_GOLD_STEP = 1, 						-- _DDEF_PEACE_COST_GOLD_STEP_ Peace Cost for 1 loan size gold of giver
...
NCountry = {
	...
	CORRUPTION_COST = 0.01,						-- cost for monthly combat per development
	...
	POWER_MAX = 9999,								-- how much power can be stored at maximum.
...
NEconomy = {
	...
	WARTAXES_DURATION = 5,							-- _EDEF_WARTAXES_DURATION_
...
NMilitary = {
	...
	ARMY_DRILL_YEARLY_DECAY = 0,					-- Loss from not Drilling
...
NReligion = {
	...
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 1500.0,				-- When spreading the religion to other provinces the distance wont exceed this number
